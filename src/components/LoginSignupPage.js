...
const LoginSignupPage = ({ setUser }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (isLogin) {
                // Perform login logic
                const response = await axios.post('https://fitness-logger-elumalai.onrender.com/auth/login', {
                    email,
                    password,
                });
                ...
                const response = await axios.post('https://fitness-logger-elumalai.onrender.com/auth/register', {
                    email,
                    password,
                    username,
                });
