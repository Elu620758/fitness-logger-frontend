...
export default function History({ user }) {
    ...
    useEffect(() => {
        const fetchExerciseData = async () => {
            try {
                const aerobicResponse = await axios.get(`https://fitness-logger-elumalai.onrender.com/aerobic/getAerobic/${userId}`);
                // console.log('Aerobic Exercise Data:', aerobicResponse.data);

                const resistanceResponse = await axios.get(`https://fitness-logger-elumalai.onrender.com/resistance/getResistance/${userId}`);
                // console.log('Resistance Exercise Data:', resistanceResponse.data);

                const cardioResponse = await axios.get(`https://fitness-logger-elumalai.onrender.com/cardio/getCardio/${userId}`);
