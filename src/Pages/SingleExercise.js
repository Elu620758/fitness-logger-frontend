...
export default function SingleExercise({ user }) {
    ...
    useEffect(() => {
        const fetchExerciseData = async () => {
            try {
                const userResponse = await axios.get(`https://fitness-logger-elumalai.onrender.com/users/userId`);
                ...
                if (userData.length > 0) {
                    ...
                    const apiEndpoint =
                        type === 'aerobic'
                            ? `https://fitness-logger-elumalai.onrender.com/aerobic/getAerobic/${fetchedUserId}`
                            : type === 'cardio'
                                ? `https://fitness-logger-elumalai.onrender.com/cardio/getCardio/${fetchedUserId}`
                                : type === 'resistance'
                                    ? `https://fitness-logger-elumalai.onrender.com/resistance/getResistance/${fetchedUserId}`
                                    : null;
    ...
    const handleDeleteExercise = async () => {
        try {
            const apiEndpoint =
                type === 'aerobic'
                    ? `https://fitness-logger-elumalai.onrender.com/aerobic/deleteAerobic/${id}`
                    : type === 'cardio'
                        ? `https://fitness-logger-elumalai.onrender.com/cardio/deleteCardio/${id}`
                        : type === 'resistance'
                            ? `https://fitness-logger-elumalai.onrender.com/resistance/deleteResistance/${id}`
                            : null;
    ...
    const handleSaveExercise = async () => {
        try {
            const apiEndpoint =
                type === 'aerobic'
                    ? `https://fitness-logger-elumalai.onrender.com/aerobic/updateAerobic/${id}`
                    : type === 'cardio'
                        ? `https://fitness-logger-elumalai.onrender.com/cardio/updateCardio/${id}`
                        : type === 'resistance'
                            ? `https://fitness-logger-elumalai.onrender.com/resistance/updateResistance/${id}`
                            : null;
